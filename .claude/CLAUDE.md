...
> O conhecimento do Claude tem corte em maio/2025. Versao alvo: 2026.1.x

**Abordagem Hibrida - Ler sob demanda:**

1. **Breaking changes** (sempre primeiro):
   - `src/firmware/ESPHOME_REFERENCE.md` - Resumo rapido (~2,500 tokens)
...
3. **Changelogs detalhados** (se precisar mais contexto):
   - `src/firmware/ESPHOME_CHANGELOG_COMPLETO.md`
