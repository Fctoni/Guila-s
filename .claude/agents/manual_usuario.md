...
**Nova alteração:**
```
Leia @.claude/agents/Planejador-Alteracoes.md
...
```
Leia @.claude/agents/Planejador-Alteracoes.md e continue @tracking/alteracoes/alteracaoXX.md
```
...
```
Leia @.claude/agents/Executor-Alteracoes.md e execute @tracking/alteracoes/spec-alteracaoXX.md
```
...
```
Leia @.claude/agents/PRD-editor.md e documente @tracking/alteracoes/spec-alteracaoXX.md no PRD
```
...
**Solução:**
```
Releia completamente @tracking/alteracoes/spec-alteracaoXX.md e continue de onde parou
```
...
```
Leia @.claude/agents/[Agente].md e continue @tracking/alteracoes/spec-alteracaoXX.md
```
...
```
Leia @.claude/agents/Executor-Alteracoes.md e continue @tracking/alteracoes/spec-alteracaoXX.md
```
...
tracking/
├── alteracoes/
│   ├── 0-regras_conversas.md             ← Regras gerais
...
```
Leia @.claude/agents/Executor-Alteracoes.md e execute @tracking/alteracoes/spec-alteracao18.md
```

### "Implementei a 18, preciso documentar no PRD"
```
Leia @.claude/agents/PRD-editor.md e documente @tracking/alteracoes/spec-alteracao18.md
```

### "Tive que parar ontem, quero continuar a execução"
```
Leia @.claude/agents/Executor-Alteracoes.md e continue @tracking/alteracoes/spec-alteracao18.md
```
