...
Regra de ouro: Se você for instruído a ler algo que não existe (por exemplo, um caminho de pasta que referencia um arquivo não existir), PARE IMEDIATAMENTE e INFORME O USUÁRIO! Não procure por arquivos parecidos, caminhos similares, etc. Esta documentação de agente deve estar 100% correta antes de você agir.
...
| Arquivo | Descrição |
|---------|-----------|
| `tracking/alteracoes/0-regras_conversas.md` | Regras de conversa e código |
| `tracking/alteracoes/template-alteracao.md` | Template de conversa/planejamento |
| `tracking/alteracoes/template-spec.md` | Template de especificação técnica |
| `tracking/alteracoes/00-indice.md` | Índice de todas as alterações |
| `PROJECT-CONTEXT.md` | Documento de requisitos do produto |
...
1. Adicione/atualize a linha em `tracking/alteracoes/00-indice.md`
2. Use o formato:
```markdown
