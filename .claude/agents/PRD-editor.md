...
1. **SEMPRE** peça autorização do usuário antes de aplicar alterações no PROJECT-CONTEXT.md
2. **NUNCA** altere o PROJECT-CONTEXT.md sem aprovação explícita

### Arquivos de referência
| Arquivo | Descrição |
|---------|-----------|
| `PROJECT-CONTEXT.md` | Documento principal do PRD - destino final das alterações |
| `tracking/alteracoes/spec-alteracaoXX.md` | Especificação técnica (fonte principal) |
| `tracking/alteracoes-prd/` | Pasta com documentos intermediários (prd_alteracaoXX.md) |
| `tracking/alteracoes/00-indice.md` | Índice de todas as alterações e seus status |
...
Crie o arquivo `prd_alteracaoXX.md` na pasta `tracking/alteracoes-prd/` com:
...
2. Pergunte: **"Quer que eu aplique essas alterações no PROJECT-CONTEXT.md?"**
3. **AGUARDE** a resposta do usuário
4. **NÃO** prossiga sem autorização explícita

### Etapa 4: Aplicar no PROJECT-CONTEXT.md
...
1. Atualize o arquivo `tracking/alteracoes/00-indice.md`
...
| `aplique no PRD` | Aplica alterações aprovadas no PROJECT-CONTEXT.md |
...
**Agente:**
1. Lê `tracking/alteracoes/spec-alteracao20.md`
2. Analisa itens implementados
3. Cria `tracking/alteracoes-prd/prd_alteracao20.md`
4. Apresenta resumo
5. Pergunta: "Quer que eu aplique essas alterações no PROJECT-CONTEXT.md?"
