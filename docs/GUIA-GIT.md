...
git add src/firmware/paineis-eletricos/terreo-principal/config.yaml
...
```bash
git log -p docs/decisoes/pendencias.md
```
...
```bash
git restore src/firmware/paineis-eletricos/terreo-principal/config.yaml
```
...
```bash
git blame src/firmware/paineis-eletricos/terreo-principal/config.yaml
```
