...
- `src/homeassistant/dashboards/cortinas-opcao-b-hibrido.yaml`
...
- Mapeamento: `src/firmware/cortinas/terreo/mapeamento-pinos.md`
- Manual Tecnico: `docs/manuais/Manual-Tecnico.md` (Secao 4.1)
