...
1. **Priorize ler também**:
   ...
   - `docs/decisoes/20251120.md` - Contexto completo das decisões iniciais
   - `docs/decisoes/Guia para IA.md` - Regras de interação
...
**Situação**: O fabricante enviou o manual (ver `docs/equipamentos/920 fh wifi si en.pdf`), mas o controlador não é compatível com a automação desejada.
...
- [✓] UEDX48480040E-WB-A (em aquisição - display quadrado 4" 480x480)
  ...
  - **Documentação**: Ver `docs/equipamentos/displays/UEDX48480040E-WB-A.md`
  - **Testes**: Ver `src/firmware/paineis-touch/validacoes/teste_UEDX48480040E/`
...
- **Especificações confirmadas (02/12/2025)**:
  ...
  - Estrutura de testes criada em `src/firmware/paineis-touch/validacoes/`
